package com.example.androidmessenger.buttonnavigation.profile;
...
import com.example.androidmessenger.LoginActivity;
...
public class Fr4agmentProfile extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding.ProfileAvatar.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        FirebaseDatabase.getInstance().getReference().child("Users").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (!profileImage.isEmpty()){
                            Glide.with(getContext()).load(profileImage).into(binding.ProfileAvatar);
                        }
                    }
